 ...
 *
 * Synchronises the order status between the iwm and the shopware store via .csv file
 * and console command.
 *
 * 1.0.0
 * - initial release
...
namespace OstOrderStatus;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstOrderStatus extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_order_status.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_order_status.view_dir', $this->getPath() . '/Resources/views/');
